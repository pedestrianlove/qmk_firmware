...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DVORAK] = LAYOUT_all(
    ...
    MO(_FN), KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_MINS, KC_NUHS, KC_ENT,
  ...
  [_QWERTY] = LAYOUT_all(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             MO(_FN), KC_RALT, DF(_DV), KC_RCTL
  ),
  ...
  [_FUNCTION] = LAYOUT_all(
    ...
    _______, KC_7,    KC_8,    KC_9,    _______, _______, _______, KC_CALC, KC_MUTE, KC_VOLD, KC_VOLU, _______,          _______,
